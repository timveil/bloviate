...
- [Database Support](https://bloviate.io/guides/database-support/) — PostgreSQL, MySQL, MariaDB, CockroachDB, H2, SQLite, DuckDB, BigQuery
...
- **PostgreSQL, MySQL, MariaDB, CockroachDB, H2, SQLite, DuckDB, BigQuery**, plus CSV/TSV/pipe **flat-file** output
